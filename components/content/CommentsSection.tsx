...
function depthStyles(depth: number) {
  ...
  return {
    ...
    body: isNested ? "text-sm leading-6 text-white/72" : "text-sm leading-6 text-white/75",
    ...
    <div className={styles.wrapper}>
      ...
      >
        <div className="flex items-start gap-3">
          <div
            className={[
              "shrink-0 rounded-full border border-white/10 bg-white/5 text-xs font-semibold text-white/80",
