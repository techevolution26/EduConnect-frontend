                ...
                {pendingQuery.data && pendingQuery.data.items.length > 0 ? (
                    <section className="space-y-4">
                        {pendingQuery.data.items.map((content) => (
                            ...
                            >
                                <div className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-[0.2em] text-fg-dim">
                                ...
                                <h2 className="font-display mt-3 text-2xl font-semibold">{content.title}</h2>
                                ...
                                <div className="mt-5 rounded-2xl border border-border bg-surface-2 p-4">
                                    <p className="line-clamp-5 text-sm leading-6 text-fg-dim">
                                        {content.body}
                                    </p>
                                </div>
